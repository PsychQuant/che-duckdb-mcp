#!/bin/bash
# Sign and notarize the CheDuckDBMCP universal binary for outside-App-Store distribution.
#
...
#
# Optional env var:
#   ENTITLEMENTS    — entitlements .plist path (default: "Sources/CheDuckDBMCP/Entitlements.plist")
...
ENTITLEMENTS="${ENTITLEMENTS:-$PROJECT_DIR/Sources/CheDuckDBMCP/Entitlements.plist}"
